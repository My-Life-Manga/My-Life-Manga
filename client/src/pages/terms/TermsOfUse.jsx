...
const TermsOfUse = () => {
  ...
  useEffect(() => {
    // get user's country using browser's navigator object
    ...
    <>
      ...
      <Container className="my-5">
        ...
        <ul>
          ...
          <li>Your use of this website and any dispute arising out of such use of the website is subject to the laws of {userCountry}.</li>
        </ul>
      </Container>
      <Footer />
    </>
